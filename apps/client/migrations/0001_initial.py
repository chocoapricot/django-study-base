    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "basic_contract_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="基本契約締結日(業務委託)"
                    ),
                ),
                (
                    "basic_contract_date_haken",
                    models.DateField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "department_code",
                    models.CharField(
                        blank=True, max_length=20, null=True, verbose_name="組織コード"
                    ),
                ),
                (
                    "postal_code",
                ...
                (
                    "is_haken_office",
                    models.BooleanField(default=False, verbose_name="派遣事業所該当"),
                ),
                (
                    "is_haken_unit",
                    models.BooleanField(default=False, verbose_name="派遣組織単位該当"),
                ),
                (
                ...
                (
                    ...
                    models.DateField(
                        blank=True, null=True, verbose_name="事業所抵触日通知日"
                    ),
                ),
                (
                    "display_order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        upload_to=apps.client.models.client_file_upload_path,
                        verbose_name="ファイル",
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["client"], name="apps_client_client__b4d28e_idx"
                    ),
                    models.Index(
                        fields=["uploaded_at"], name="apps_client_uploade_82d93b_idx"
                    ),
                ],
            },
        ),
