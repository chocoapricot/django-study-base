            ...
            if flag.company_user and flag.company_user.email:
                ...
                try:
                    ...
                    Notification.objects.create(
                        user=user,
                        title=f'スタッフフラッグが登録されました',
                        message=f'スタッフ「{staff.name}」にフラッグ「{flag.flag_status.name}」が登録されました。',
                        notification_type='general',
                        link_url=reverse('staff:staff_detail', kwargs={'pk': staff.pk}),
            ...
            if has_changes:
                ...
                if updated_flag.company_user and updated_flag.company_user.email:
                    ...
                    try:
                        ...
                        Notification.objects.create(
                            user=user,
                            title=f'スタッフフラッグが更新されました',
                            message=f'スタッフ「{staff.name}」のフラッグ「{updated_flag.flag_status.name}」が更新されました。',
                            notification_type='general',
                            link_url=reverse('staff:staff_detail', kwargs={'pk': staff.pk}),
