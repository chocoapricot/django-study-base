...
class StaffViewsOtherTest(TestCase):
    ...
    def test_mynumber_detail_view_with_permission(self):
        StaffMynumber.objects.create(staff=self.staff, mynumber="123456789012", tenant_id=1)
    ...
    def test_bank_detail_view_with_permission(self):
        StaffBank.objects.create(staff=self.staff, bank_code='1234', branch_code='123', account_type='普通', account_number='1234567', account_holder='テスト スタッフ', tenant_id=1)
    ...
    def test_international_detail_view_with_permission(self):
        StaffInternational.objects.create(staff=self.staff, residence_card_number='AB12345678CD', residence_status='Engineer', residence_period_from=date(2023, 1, 1), residence_period_to=date(2025, 1, 1), tenant_id=1)
    ...
    def test_disability_detail_view_with_permission(self):
        StaffDisability.objects.create(staff=self.staff, disability_type='身体障害', tenant_id=1)
    ...
    def test_contact_detail_view_with_permission(self):
        StaffContact.objects.create(staff=self.staff, emergency_contact='09012345678', tenant_id=1)
