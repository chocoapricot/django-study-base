...
class RegistFormFilterTest(TestCase):
    ...
    def test_staff_regist_status_filter_with_search(self):
    ...
    def test_staff_regist_status_filter_with_sort(self):
    ...
    def test_staff_regist_status_filter_pagination_links(self):
