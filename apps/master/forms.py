...
class OvertimePatternForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'flexible_daily_overtime_enabled', 'flexible_daily_overtime_hours', 'flexible_daily_overtime_minutes',
            'flexible_weekly_overtime_enabled', 'flexible_weekly_overtime_hours', 'flexible_weekly_overtime_minutes',
        ...
        widgets = {
            ...
            'flexible_daily_overtime_minutes': forms.NumberInput(attrs={'class': 'form-control form-control-sm', 'min': '0', 'max': '59'}),
            ...
            'flexible_weekly_overtime_minutes': forms.NumberInput(attrs={'class': 'form-control form-control-sm', 'min': '0', 'max': '59'}),
