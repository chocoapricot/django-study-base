...
class OvertimePatternForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'variable_daily_overtime_enabled', 'variable_daily_overtime_hours', 'variable_daily_overtime_minutes',
            'variable_weekly_overtime_enabled', 'variable_weekly_overtime_hours', 'variable_weekly_overtime_minutes',
        ...
        widgets = {
            ...
            'variable_daily_overtime_enabled': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'variable_daily_overtime_hours': forms.NumberInput(attrs={'class': 'form-control form-control-sm'}),
            'variable_daily_overtime_minutes': forms.NumberInput(attrs={'class': 'form-control form-control-sm', 'min': '0', 'max': '59'}),
            'variable_weekly_overtime_enabled': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'variable_weekly_overtime_hours': forms.NumberInput(attrs={'class': 'form-control form-control-sm'}),
            'variable_weekly_overtime_minutes': forms.NumberInput(attrs={'class': 'form-control form-control-sm', 'min': '0', 'max': '59'}),
