# Generated by Django 5.2.8 on 2025-11-26 16:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('master', '0028_overtimepattern_calculate_midnight_premium'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.CharField(choices=[('text', 'テキスト'), ('textarea', 'テキストエリア'), ('boolean', '真偽値'), ('number', '数値')], default='text', max_length=10, verbose_name='形式')),
