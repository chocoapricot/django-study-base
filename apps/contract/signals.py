...
def run_teishokubi_calculation(instance):
    ...
    if client_contract.client_contract_type_code == Constants.CLIENT_CONTRACT_TYPE.DISPATCH and staff_contract.employment_type and staff_contract.employment_type.is_fixed_term:
