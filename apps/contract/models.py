...
class ContractClientFlag(MyFlagModel):
    """
...
class ContractStaffFlag(MyFlagModel):
    """
    スタッフ契約のフラッグ情報を管理するモデル。
    """
    staff_contract = models.ForeignKey(
        StaffContract,
        on_delete=models.CASCADE,
...
class ContractAssignmentFlag(MyFlagModel):
    """
