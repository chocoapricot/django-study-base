...
SAMPLE_DATA_FILES = [
    ...
    ("_sample_data/master_staff_tag.json", "スタッフタグマスタデータ"),
    ("_sample_data/master_client_tag.json", "クライアントタグマスタデータ"),
    ...
    ("_sample_data/staff_grade.json", "スタッフ等級データ"),
    ...
    ("_sample_data/staff_contact_schedule.json", "スタッフ連絡予定データ"),
    ("_sample_data/staff_payroll.json", "スタッフ給与データ"),
    ("_sample_data/staff_evaluation.json", "スタッフ評価データ"),
    ("_sample_data/staff_favorite.json", "スタッフお気に入りデータ"),
    ...
    ("_sample_data/client_contact_schedule.json", "クライアント連絡予定データ"),
    ("_sample_data/client_favorite.json", "クライアントお気に入りデータ"),
